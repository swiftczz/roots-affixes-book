...
第 23-25 章讲了法语进入英语的历史、厨房阶级、三层词。这一章我们补全**法语来源的高频词根和词族**。
...
> **提示** **`courteous`(有礼貌的)字面义是"宫廷式的"**——古法语宫廷被认为是礼仪的典范,所以"宫廷的"= "有礼貌的"。
...
> **提示** **`artificial`(人造的)字面义是"用技艺做出来的"**——和自然(natural)相对。今天 artificial 多带"虚假"义,但词源是中性的"技艺产物"。
...
法语在政治法律领域留下了大量词,因为 1066 年后这些领域由诺曼人掌控:
...
> **提示** `soldier` 与 *solidus* 货币名称的关系较明确;`salary` 虽与盐词族有关,但"罗马士兵领盐钱"缺乏可靠古代证据。两者不能并列成两个已经证实的军饷故事。
...
> **提示** 所以 `treasure`(财宝)和 `thesaurus`(同义词词典)**同根**——都来自希腊"宝库"。一本同义词词典,就是"词语的财宝"。
...
3. **几个值得辨析的词源**:`money` 与 Juno Moneta 铸币传统有关,`government` 与掌舵词族有关,`soldier` 与 *solidus* 有关。

### 一个最离奇的认知

> **money 的可靠路径经过 Juno Moneta 神庙与罗马铸币传统;Moneta 是否就是"警告者"仍有争议。**
...
2. `parliament` 为什么更准确地解释为"谈话、讨论、会议",而不是"`-ment` 表地点"?
3. `soldier` 与 `salary` 的证据强度有什么不同?为什么不能把 `salary` 直接译成"盐钱"?
