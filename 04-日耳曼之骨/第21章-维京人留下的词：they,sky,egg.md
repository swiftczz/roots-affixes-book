...
古英语 *giefan* 与古诺尔斯语 *gefa* 是近亲。现代 `give` 的硬 /ɡ/ 常被视为北欧接触影响的重要线索,因为相关古英语形式经历过腭化,古诺尔斯语近亲则保留硬音。不过词形可能受方言接触和近亲形式混合共同影响,不能只凭这一声 /ɡ/ 就宣布“维京人独家冠名”。更稳妥的说法是:这枚指纹很醒目,完整身份仍要看整条历史证据链。
...
不少维京借词带着常见的**拼写线索**,能帮你缩小排查范围;但线索不是护照,最后仍要查词史:

1. **硬 `sk-` 开头(sk 而不是 sh)**
   古英语的 sk 在中部英语变成了软软的 `sh`(`ship`, `shall`),但维京词的 sk 死活不改,硬邦邦地留了下来:
   `sky`(天空)、`skin` /skɪn/(皮肤)、`skull` /skʌl/(头骨)、`ski` /ski/(滑雪)、`skirt` /skɜrt/(裙子)、`skill` /skɪl/(技能)里,不少确实走了斯堪的纳维亚路线。听到硬 `sk-`,可以在调查表上打一个圈,不能当场把所有嫌疑词都判成维京籍——英语后来还会从别的语言借来 `sk-` 词。
...
1. `window` 字面是"风眼"(vind-auga);为什么不能仅凭这个构造断言它"最初一定是屋顶排烟孔"?字面到底告诉了你什么、没告诉你什么?
2. 为什么 `they/their/them` 这种最核心的代词也能被借进英语?回答时应考虑哪些语言接触因素?"古诺尔斯代词更清晰"能不能算已证实的原因?
3. 本章说维京借词常保留硬 `sk-`,古英语同源词却腭化成 `sh-`。据此判断：`skirt` 和 `shirt` 这对"双胞胎",哪个是维京借词、哪个是本土词?你还能用哪些线索识别一个词可能来自古诺尔斯语?
