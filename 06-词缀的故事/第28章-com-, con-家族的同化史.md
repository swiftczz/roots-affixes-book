...
1. **(破除误解)** `corrupt` 的 `cor-` 为什么应理解为强化形式,而不是"一起"?本章说 con-/com- 有"两张脸",那给你一个 con- 词,你怎么判断它这次是"共同"还是"加强"?
2. **(讲证据)** `cone`(圆锥)开头也有 `con`,却不属于这个"共同"家族。你怎么判断一个 con-/com- 词到底属不属于?"共同+词根讲不讲得通"是个好办法吗?够不够?
3. **(迁移应用)** `com-` 随后面辅音同化。请拼出正确形式-`com-`+labor、`com-`+rect、`com-`+operate、`com-`+nect,并说明为什么会有这五种"衣裳"。
