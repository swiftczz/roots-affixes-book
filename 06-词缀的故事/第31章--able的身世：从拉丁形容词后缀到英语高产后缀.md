...
`comfortable` 是语义漂移界的经典案例。它背后的 `comfort` 经古法语 *conforter* 追溯到拉丁 ***confortare***,核心是“**使强壮、给予力量**”。对,你屁股底下那张柔软沙发,词源祖先并不是一团棉花,而是一句“撑住,我给你加点力量”。但它也没有一份必须先去给城墙加固的履历,别让堡垒抢走人的工作证。

那么,“给力量”怎么变成软沙发?路线是:`confortare` 的“使强壮、支持”进入古法语和英语后,发展出“鼓舞、安慰”;`comfortable` 又从“能给予安慰、令人宽慰”逐渐走到“身体或环境让人舒适”。这是语义学里一次彻底的软化手术——**同一个词,早年负责扶你站稳,今天负责让你躺平。**
...
一句话对照:**`-able` 常问“可不可以、适不适合”,`-ive` 常说“与这个动作有什么功能或性质”。** 这是观察方向,不是自动翻译器;具体整词仍得查用法。
...
1. `-able` 一般表示"能被……的"(被动),可 `comfortable` 却是"令人舒适的"(主动),`readable` 是"能被读的"(被动)。为什么同一个 `-able` 会有两种?这提醒你拆 `-able` 词时不能怎么做?
2. `-able` 和 `-ible` 只差一个字母、读音也几乎一样。为什么不能靠一条"什么时候用 a、什么时候用 i"的规则拼对?它俩的分工是怎么来的?拿不准时该怎么办?
3. `remarkable` = remark(谈论)+ able,却意为"非凡"。请解释这条引申(顺便说说 `-able` 除"能被"外还能表什么)。再判断：随手造的 `sleepable` 为什么不一定成词——`-able` 能加在任意动词后吗?
