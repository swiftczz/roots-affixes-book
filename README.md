...
- **学术限定不泼冷水**:相关章节在章末用"避坑提示"集中说明哪些是简化、哪些有争议、哪些是传说成分。正文先把故事讲痛快,严谨性留到章末一并交代
- 对于有多种学术说法的词源(如 `sincere` 的真正来源),列出主流观点,不装确定
- 全书区分**历史词源成分**、**现代英语中仍可产的词缀**和**仅供记忆的切分**,避免把相似拼写都当成语素
- **标音面向约 2500 词汇量**:正文各章对较可能陌生或容易读错的现代英语词,在本章第一次出现时标注美式 IPA;基础常用词不逐个标注,拉丁语、希腊语等来源词形也不硬套英语读音
