...
`sub-`(在下面)+ `stant`(站)提供“在下面站着”的字面画面。后来的拉丁哲学传统用 *substantia* 等术语处理希腊 *ousia* 一类复杂概念;翻译和哲学史远比“底下有根柱子”麻烦。橡树负责让你先抓住托底意象,精确定义仍得交给哲学原文。
...
> **提示** `existence`、`state` 与“站立”词族有历史亲缘,英语 `stand` 则是更早的印欧远亲,不是拉丁 *stare* 的直接后代。词源能展示“站出、立住”怎样参与语义发展,不能据此概括所有古罗马人的存在观。
...
*下一章 → [第 12 章 罗马人的法律：lex, jus](./第12章-罗马人的法律：lex,%20jus.md)*
