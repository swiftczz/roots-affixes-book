...
> 反向联想:如果一个人走过去,你连眼皮都不抬一下,现代语义上可以联想到 *contempt*(蔑视)。但 `contempt` 来自拉丁 *contemnere*(轻视),不能拆成“一起蔑视”,也不是 specere 家族派来和 respect 对打的亲兄弟。
...
神鸡扑腾着被海浪吞没。Pulcher 拔锚出征。结果呢?**这是罗马海军在第一次布匿战争中最惨重的败仗之一**——古代记录称约 93 艘罗马战船被俘,另有舰船沉没,死亡或被俘者常估为约两万人。舰队没到“九万人集体下海”那么夸张,但已经惨到足够让罗马人记住一句话:神鸡比执政官更懂海战。
...
**历史构形**:`spectacle` /ˈspɛktəkəl/ 经法语追溯到拉丁 *spectaculum*(供观看的事物、演出),核心仍是 `spect-`“看”;尾部来自拉丁历史词形,不能把现代英语 `-acle` 当成“值得……的东西”到处粘贴。`spectator` /ˈspɛkteɪtər/ 则来自拉丁“观看者”词族,就是来看的人。
...
这两样东西,一个管肚子,一个管眼睛——而管眼睛的那一样,正是 specere 家族发家的本行。不过罗马 **circus** 主要是长条形赛车竞技场,Colosseum 则是 **amphitheatre**(圆形或椭圆形露天竞技场);两者都热闹,门牌不能互换。
 ...
 **稳妥的说法**:两者都与“看”有关,但**不能确认同根**。这里把它们称为“语义相近”,而不是“词源同根”——意思撞衫,不等于族谱同页。
...
1. 有人总结出一条"拆字公式":`spec` 词 = 前缀方向 + 看,所以字面义就等于它今天的意思。请用本章的 `suspect`(从下往上看)和 `respect`(回头看)两个词,说明这条公式在什么地方会失灵;那么"拆字"到底该在记单词的哪一步派上用场?
2. `auspice` /ˈɔspɪs/ 的 `au-` 很容易被当成 *aurum*(金)——理解成"看到金子=吉利"。本章给的是另一种来源。假设你手边没有词典,只凭 `augur`、`inaugurate`、`auspicious` 这几个同族词,你能找到哪些线索来支持"`au-` = 鸟(*avis*)"而不是"金"?
3. 给你一个本章没讲过的词 `perspicacious` /ˌpɜrspɪˈkeɪʃəs/(敏锐的、有洞察力的)。先用 spec 家族的方法拆出它的字面义、推测词义是怎么来的;再回答：为什么这样拆能帮你**记住**它,却不足以让你在写作中**用准**它?
